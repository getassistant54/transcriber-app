...
let adminSettings: AdminSettings = {
  ...
  plans: [
    ...
    },
    {
      ...
      priceRub: 990,
      priceUsd: 11,
      features: ['15 часов расшифровки в месяц', 'Безлимитная длина видео', 'Расширенный анализ задач и таймкодов', 'Приоритетная обработка', 'История без ограничений'],
    },
    {
      id: 'corporate_team',
      ...
      priceRub: 4900,
      priceUsd: 55,
      features: ['100 часов для всей команды', 'Ролевая модель и доступ сотрудников', 'Пользовательские ИИ-промпты', 'Брендированный экспорт в Google Docs', 'Выделенный API ключ и админка'],
    },
  ],
};
